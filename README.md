This repository contains the [Editor's Draft](https://w3ctag.github.io/ethical-web-principles/) of the [W3C TAG Ethical Web Principles]([https://www.w3.org/2001/tag/doc/ethical-web-principles/](https://www.w3.org/TR/ethical-web-principles/)), now a [W3C Statement](https://www.w3.org/standards/types/#STMT). Here's the abstract:
